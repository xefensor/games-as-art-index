...
Describe the resource, collection, correction, or product change.

## Editorial evidence

- Original source:
- Creator/publisher verified:
- Publication year and access checked:
- Thumbnail source and reuse basis checked:

## Checklist

- [ ] I edited files under `content/`; I did not hand-edit generated catalogue records only.
